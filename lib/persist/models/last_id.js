 ...
 * on any client. Sometimes you want an ascending number or tiny-id
 ...
 *
 * The data model doesn't guarantee uniqueness. That's the responsibility
 * of the application using the data model.
 */
